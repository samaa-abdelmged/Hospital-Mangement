...
@section('title')
    {{ trans('Dashboard/accounts.document_informations') }}
@stop
@section('css')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                </h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('Dashboard/accounts.document_informations') }}
                ...
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('Receipt.create') }}" class="btn btn-primary" role="button" aria-pressed="true">
                            {{ trans('Dashboard/accounts.add_new_receipt') }}
                        </a>
                    </div>
                </div>
                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('Receipt.show', $receipt->id) }}"
                                                ...
                                                title={{ trans('Dashboard/accounts.print_receipt') }}><i
