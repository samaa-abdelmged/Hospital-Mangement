...
@section('title')
    {{ trans('main-sidebar_trans.invoices_list') }}
        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"> {{ trans('main-sidebar_trans.patient_processes') }}</h4><span
                    ...
                    {{ trans('main-sidebar_trans.invoices_list') }}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                    ...
                    <div class="table-responsive">
                        <table style="text-align: center" class="table text-md-nowrap" id="example1">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th> {{ trans('patient/patient_processes.invoice_date') }}</th>
                                    <th> {{ trans('patient/patient_processes.doctor_name') }}</th>
                                    <th> {{ trans('patient/patient_processes.service_name') }} </th>
                                    <th> {{ trans('patient/patient_processes.total') }}</th>
                                </tr>
                            </thead>
                            <tbody>
