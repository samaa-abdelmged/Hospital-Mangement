    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"> {{ trans('doctor/reveals.lab_details_delete') }}</h5>
            ...
            <div class="modal-body">
                <form action="{{ route('Laboratories.destroy', $patient_Laboratorie->id) }}" method="post">
                    ...
                    <div class="row">
                        <div class="col">
                            <p class="h5 text-danger"> {{ trans('doctor/reveals.lab_details_delete_makesure') }}</p>
