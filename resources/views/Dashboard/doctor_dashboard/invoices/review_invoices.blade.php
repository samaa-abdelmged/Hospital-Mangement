...
@section('title')
    {{ trans('doctor/reveals.review_reveals') }}
@stop
@section('css')
...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"> {{ trans('doctor/reveals.review_reveals') }}</h4><span
                                        ...
                                        <td>
                                            @if ($invoice->invoice_status == 1)
                                                <span class="badge badge-danger">
                                                    {{ trans('doctor/reveals.under_procedure') }}</span>
                                            @elseif($invoice->invoice_status == 2)
                                                <span class="badge badge-warning">
                                                    {{ trans('doctor/reveals.review') }}</span>
                                            @else
                                                <span class="badge badge-success">
                                                    {{ trans('doctor/reveals.completed') }}</span>
                                            @endif
                                        </td>
