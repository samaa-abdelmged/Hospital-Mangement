...
@endsection
@section('title')
    {{ trans('doctor/reveals.patient_data') }}
@endsection
@section('page-header')
    <!-- breadcrumb -->
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"> {{ trans('doctor/reveals.patient_data') }} </h4><span
                                                ...
                                                <table class="table table-hover text-md-nowrap text-center">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th> {{ trans('doctor/reveals.doctor_name') }} </th>
                                                            <th> {{ trans('doctor/reveals.ray_employee_name') }} </th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($patient_rays as $patient_ray)
                                                            <tr>
                                                                ...
                                                                @if ($patient_ray->case == 0)
                                                                    <td class="text-danger">
                                                                        {{ trans('doctor/reveals.not_completed') }} </td>
                                                                @else
                                                                    <td class="text-success">
                                                                        {{ trans('doctor/reveals.completed') }} </td>
                                                                @endif
                                                            ...
                                                            @include('Dashboard.doctor_dashboard.invoices.edit_xray_conversion')
                                                            @include('Dashboard.doctor_dashboard.invoices.deleted')
                                                        @endforeach
                                                    </tbody>
                                                </table>
                                            </div>
                                                ...
                                                <table class="table table-hover text-md-nowrap text-center">
                                                    ...
                                                    <tbody>
                                                        @foreach ($patient_Laboratories as $patient_Laboratorie)
                                                            ...
                                                            @include('Dashboard.doctor_dashboard.invoices.edit_laboratorie_conversion')
                                                            @include('Dashboard.doctor_dashboard.invoices.deleted_laboratorie')
                                                        @endforeach
                                                    </tbody>
                                                </table>
                                            </div>
