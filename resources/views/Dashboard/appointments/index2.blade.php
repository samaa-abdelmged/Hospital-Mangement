...
@section('title')
    {{ trans('dashboard/appointments.confirmed_appointments') }}
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto"> {{ trans('dashboard/appointments.appointments_list') }}</h4>
                ...
                <div class="table-responsive">
                    <table class="table text-md-nowrap" id="example1">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>{{ trans('dashboard/appointments.patient_name') }}</th>
                                ...
                                <th>{{ trans('dashboard/appointments.date') }}</th>
                                <th>{{ trans('dashboard/appointments.phone') }}</th>
                                <th>{{ trans('dashboard/appointments.operator') }}</th>
