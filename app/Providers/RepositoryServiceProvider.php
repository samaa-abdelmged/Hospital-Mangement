...
use App\Repository\Dashboard_Employee\LaboratorieEmployee\LaboratorieEmployeeRepository;
use App\Repository\Dashboard_Employee\RayEmployee\RayEmployeeRepository;
use App\Repository\Dashboard_Patient\PatientProcessesRepository;
...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind('App\Interfaces\Dashboard_Employee\Invoices\InvoicesRepositoryInterface',
            'App\Repository\Dashboard_Employee\Invoices\InvoicesRepository');
        $this->app->bind(LaboratorieEmployeeRepositoryInterface::class, LaboratorieEmployeeRepository::class);

        $this->app->bind('App\Interfaces\Dashboard_Employee\LaboratorieEmployee\InvoicesRepositoryInterface',
            'App\Repository\Dashboard_Employee\LaboratorieEmployee\InvoicesRepository');
        ///////////////////////////////////////////////////////////////////////


        //patient
        $this->app->bind(PatientProcessesRepositoryInterface::class, PatientProcessesRepository::class);
        ///////////////////////////////////////////////////////////////////////
